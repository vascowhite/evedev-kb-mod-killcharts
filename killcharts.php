...
class killcharts extends pageAssembly {
    ...
    function menuSetup() {
        ...
        $this->addMenuItem("link", "Previous " . $this->getPeriodName(), "?a=killcharts&amp;" . $this->getPreviousPeriodLink() . $suffix . $suffixscl);
        if (!$this->isCurrentPeriod()) {
            $this->addMenuItem("link", "Next " . $this->getPeriodName(), "?a=killcharts&amp;" . $this->getNextPeriodLink() . $suffix . $suffixscl);
        }
        $this->addMenuItem("link", "Home", "?a=home");
        return "";
    }
    ...
    function setDay($day) {
        $this->period = $day;
        $this->previousPeriodLink = 'd=' . date($this->dateFormat, strtotime($this->period) - $this->oneDaySecs);
        $this->nextPeriodLink = 'd=' . date($this->dateFormat, strtotime($this->period) + $this->oneDaySecs);
    }
